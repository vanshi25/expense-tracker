...
if (percentage > 100) {
  ...
  >
    ...
    {percentage >= 80 &&
      percentage <= 100 && (
        <div className="mt-3 bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200 p-3 rounded-lg text-sm">
          ⚠ You have used {percentage.toFixed(0)}% of your budget.
        </div>
      )}

    {percentage > 100 && (
      <div className="mt-3 bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200 p-3 rounded-lg text-sm">
    ...
    <p
      className={`mt-3 font-semibold ${statusColor}`}
    >
      {status}
    </p>
  </div>
